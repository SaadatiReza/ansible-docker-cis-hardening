[x] 5.1 Ensure swarm mode is not Enabled, if not needed (Manual) --> This task just collection information about the current state of the swarm mode of the host.
